...
const (
	OptimizationLevel0 OptimizationLevel = iota // None
	OptimizationLevel1                          // All optimizations minus composite constant folding (e.g., ArrayNode of constants to ConstantNode)
	OptimizationLevel2                          // All optimizations
)
...
type Config struct {
	...
	Expect            reflect.Kind
	ExpectAny         bool
	Optimize          bool              // Whether to optimize the AST and generated bytecode
	OptimizationLevel OptimizationLevel // What optimizations to apply
	Strict            bool
	Profile           bool
...
func CreateNew() *Config {
	c := &Config{
		Optimize:          true,
		OptimizationLevel: OptimizationLevel2,
